  ...
  return (
    <div className="max-w-full md:mx-10 lg:mx-20 xl:mx-auto">
      ...
      >
        ...
        <h2 className="md:mx-32 mb-10 text-xl text-center text-gray-200 md:text-2xl">
          Are you a true football enthusiast? Or perhaps someone who enjoys
          engaging in passionate conversations about thrilling matches? Whatever
          your level of passion for the sport, we invite you to embark on an
          exciting journey on Futteboxd.
        </h2>
        {
        ...
        <div className="flex -ml-4 space-x-4 text-center text-gray-100 md:justify-center md:space-x-8">
          <div className="ml-4">No credit card required</div>
        </div>
      </div>
    </div>
  );
